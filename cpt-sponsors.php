...
function sponsors() {
	...
	'archives'              => __( 'Sponsors', 'text_domain' ),
	...
	'description'           => __( 'Recent Sponsors', 'text_domain' ),
	'labels'                => $labels,
...
function bdng_change_sponsors_title( $title ) {
	...
	return $title;
			...
			add_filter( 'enter_title_here', 'bdng_change_sponsors_title' );
// END Sponsors CPT
